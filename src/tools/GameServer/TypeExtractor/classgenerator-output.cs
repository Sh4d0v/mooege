    ...
    {
        public PlayerSavedData Field0;
        public int Field1;

        public override void Parse(GameBitBuffer buffer)
        {
            Field0 = new PlayerSavedData();
            Field0.Parse(buffer);
            Field1 = buffer.ReadInt(32);
        }
    ...
    public class TrickleMessage : GameMessage
    {
        ...
        public override void Encode(GameBitBuffer buffer)
        {
            ...
            if(Field16.HasValue)
                buffer.WriteInt(32, Field16.Value);
            if(Field17.HasValue)
                buffer.WriteInt(32, Field17.Value);
        }
    ...
    public class PetMessage : GameMessage
    {
        ...
        public int Field2;
        int _Field3;
        public int Field3 { get { return _Field3; } set { if(value < -1 || value > 66) throw new ArgumentOutOfRangeException(); _Field3 = value; } }
    ...
    public class EngagedMessage : GameMessage
    {
        int _Field0;
        public int Field0 { get { return _Field0; } set { if(value < 0 || value > 7) throw new ArgumentOutOfRangeException(); _Field0 = value; } }
        public int snoActorMonster;
        int _Field2;
        public int Field2 { get { return _Field2; } set { if(value < -1 || value > 11) throw new ArgumentOutOfRangeException(); _Field2 = value; } }
        int[] _Field3;
    ...
    public class PlayerDWordDataMessage : GameMessage
    {
        public int Field0;
        public int Field1;
    ...
    {
        \\TESTING
        public byte[3] _Field0;
        public byte[3] Field0 { get { return _Field0; } set { _Field0 = value; } }
    ...
    {
        public string _Field0;
        public string Field0 { get { return _Field0; } set { if(value != null && value.Length > 16) throw new ArgumentOutOfRangeException(); _Field0 = value; } }
